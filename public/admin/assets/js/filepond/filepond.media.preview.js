...
!(function (e, i) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ? define(i)
      : ((e = "undefined" != typeof globalThis ? globalThis : e || self).FilePondPluginMediaPreview = i());
})(this, function () {
  "use strict";
  ...
  class t {
    ...
    play() {
      this.mediaEl.paused ? this.mediaEl.play() : this.mediaEl.pause(), this.audioElems.button.classList.toggle("play"), this.audioElems.button.classList.toggle("pause");
    }
    timeUpdate() {
      let e = (this.mediaEl.currentTime / this.duration) * 100;
      (this.audioElems.playhead.style.marginLeft = e + "%"), this.mediaEl.currentTime === this.duration && (this.audioElems.button.classList.toggle("play"), this.audioElems.button.classList.toggle("pause"));
    }
    moveplayhead(e) {
    ...
    timelineClicked(e) {
      this.moveplayhead(e), (this.mediaEl.currentTime = this.duration * this.clickPercent(e));
    }
    mouseDown() {
      (this.onplayhead = !0), window.addEventListener("mousemove", this.moveplayheadFn, !0), this.mediaEl.removeEventListener("timeupdate", this.timeUpdate.bind(this), !1);
    }
    mouseUp(e) {
      window.removeEventListener("mousemove", this.moveplayheadFn, !0),
        1 == this.onplayhead && (this.moveplayhead(e), (this.mediaEl.currentTime = this.duration * this.clickPercent(e)), this.mediaEl.addEventListener("timeupdate", this.timeUpdate.bind(this), !1)),
        (this.onplayhead = !1);
    }
    clickPercent(e) {
      return (e.clientX - this.getPosition(this.audioElems.timeline)) / this.timelineWidth;
    }
    getPosition(e) {
    ...
    d.utils.createView({
        ...
        const n = ((d) =>
          d.utils.createView({
            ...
            create: ({ root: e, props: t }) => {
              ...
              if (((e.ref.media = document.createElement(s)), e.ref.media.setAttribute("controls", !0), e.element.appendChild(e.ref.media), i(a.file))) {
            ...
            write: d.utils.createRoute({
              DID_MEDIA_PREVIEW_LOAD: ({ root: d, props: a }) => {
                ...
                let link = o.createObjectURL(l)
                if (typeof n.source == "string") {
                  link = window.location.origin + "/api/get-file/" + n.source
                }
                (d.ref.media.type = n.file.type),
                  (d.ref.media.src = (n.file.mock && n.file.url) || link),
                  ...
                  d.ref.media.addEventListener(
                    ...
                    () => {
                      ...
                      d.dispatch("DID_UPDATE_PANEL_HEIGHT", { id: a.id, height: i });
                    },
                    !1
                  );
              },
      ...
      write: d.utils.createRoute({
        DID_MEDIA_PREVIEW_CONTAINER_CREATE: ({ root: e, props: i }) => {
          const { id: t } = i;
          e.query("GET_ITEM", t) && e.dispatch("DID_MEDIA_PREVIEW_LOAD", { id: t });
        },
      }),
    }),
    a = (t) => {
            ...
            o(
              {
                DID_LOAD_ITEM: ({ root: t, props: d }) => {
                  ...
                  o && !o.archived && ((e(o.file) && r) || (i(o.file) && h)) && ((t.ref.mediaPreview = a.appendChildView(a.createChildView(l, { id: n }))), t.dispatch("DID_MEDIA_PREVIEW_CONTAINER_CREATE", { id: n }));
                },
              },
              ({ root: t, props: d }) => {
                const { id: a } = d,
                ...
                n && ((e(n.file) && o) || (i(n.file) && l)) && t.rect.element.hidden;
              }
            )
          );
        }),
        { options: { allowVideoPreview: [!0, n.BOOLEAN], allowAudioPreview: [!0, n.BOOLEAN] } }
      );
    };
  return "undefined" != typeof window && void 0 !== window.document && document.dispatchEvent(new CustomEvent("FilePond:pluginloaded", { detail: a })), a;
});
